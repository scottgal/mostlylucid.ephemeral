...
public class EmbedderAtomTests
{
    ...
    public async Task DefaultContractMatchesKind()
    {
        ...
        await using var atom = new EmbedderAtom<int, int>(typed, Handler);
    ...
    public async Task RunAsyncEmitsTypedSignalAndReturnsOutput()
    {
        ...
        await using var atom = new EmbedderAtom<int, int>(typed, Handler, outputSignal: "embedder.output");
    ...
    public async Task EmitOutputSignalsFalseSuppressesEmission()
    {
        ...
        await using var atom = new EmbedderAtom<int, int>(typed, Handler, emitOutputSignals: false);
