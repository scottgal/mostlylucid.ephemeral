...
public class GuardAtomTests
{
    ...
    public async Task DefaultContractMatchesKind()
    {
        ...
        await using var atom = new GuardAtom<int, int>(typed, Handler);
    ...
    public async Task RunAsyncEmitsTypedSignalAndReturnsOutput()
    {
        ...
        await using var atom = new GuardAtom<int, int>(typed, Handler, outputSignal: "guard.output");
    ...
    public async Task EmitOutputSignalsFalseSuppressesEmission()
    {
        ...
        await using var atom = new GuardAtom<int, int>(typed, Handler, emitOutputSignals: false);
